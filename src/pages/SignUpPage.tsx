...
export default function SignUpPage() {
  ...
  const { signUp, error, clearError, isAuthenticated, isLoading } = useAuthStore();
  ...
  return (
    <div className="min-h-screen bg-earth-50 dark:bg-night-900 flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary-100 dark:bg-primary-900/20 rounded-full blur-3xl opacity-30 -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent-100 dark:bg-accent-900/20 rounded-full blur-3xl opacity-30 translate-y-1/2 -translate-x-1/2" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white dark:bg-night-800 rounded-3xl border border-earth-200 dark:border-night-700 shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-earth-900 dark:text-earth-50 mb-2">إنشاء حساب جديد</h1>
            <p className="text-sm text-earth-500 dark:text-earth-400">ابدأ رحلتك نحو حياة أفضل</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-earth-400 dark:text-earth-500 mt-1.5">يجب أن تكون كلمة المرور 6 أحرف على الأقل</p>
            </div>
        ...
        {/* Terms */}
        <p className="text-center text-xs text-earth-400 dark:text-earth-500 mt-6">
